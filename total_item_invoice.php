<center>
<h1>Total Items Sale in one invoice</h1>
</center><br>
...
$from_date  = $_POST['from_date'];
 ...
 if (empty($date)){
$s_emp = "SELECT DATE_FORMAT(a.entry_date,'%d-%m-%Y') as entry_date , invoice_no,item_id, sum(product_qty*current_rate) as amount,
...
GROUP BY DATE_FORMAT(a.entry_date,'%d-%m-%Y'),invoice_no,item_id";
}else{
...
<td style="border:1px solid black; background-color: #dddddd"><?php echo $item_id; ?></td>
...
<td style="border:1px solid black; background-color: #dddddd"><?php echo $net_amount; ?></a></td> 
